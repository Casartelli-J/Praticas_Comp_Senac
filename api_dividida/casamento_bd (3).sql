...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15/04/2026 às 20:18
...
(5, 'Ramon Salazar', 'raMONcito@gmail.com', '51 998653325', 15, 0);
...
--
ALTER TABLE `convidados`
  MODIFY `ID_convidado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
